...
// Full page loading component with LocalityBay branding
export function FullPageLoading({ text = "Loading..." }: { text?: string }) {
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-blue-50 via-white to-green-50 z-50 flex items-center justify-center">
      <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl p-12 flex flex-col items-center space-y-6 border border-blue-100">
        {/* LocalityBay Logo Animation */}
        <div className="relative">
          <div className="h-16 w-16 border-4 border-blue-200 border-t-blue-500 rounded-full animate-spin"></div>
          <div className="absolute inset-0 h-16 w-16 border-4 border-transparent border-r-green-300 rounded-full animate-spin [animation-direction:reverse] [animation-duration:2s]"></div>
          <div className="absolute inset-2 h-12 w-12 bg-gradient-to-br from-blue-500 to-green-500 rounded-full flex items-center justify-center">
            <div className="h-6 w-6 bg-white rounded-full animate-pulse"></div>
          </div>
        </div>
        
        {/* LocalityBay Branding */}
        <div className="text-center">
          ...
          <p className="text-sm text-gray-500 mt-2">Connecting communities...</p>
        </div>
